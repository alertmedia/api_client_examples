...
namespace AlertMedia.CodeGen.Api
{
    ...
    public interface IUserApi : IApiAccessor
    {
        ...
        /// <returns></returns>
        void SetPhoto (long? userId, System.IO.Stream photo);
        ...
        System.Threading.Tasks.Task SetPhotoAsync (long? userId, System.IO.Stream photo);
    ...
    public partial class UserApi : IUserApi
    {
        ...
        /// <param name="photo">The file to upload.</param>
        /// <returns></returns>
        public void SetPhoto (long? userId, System.IO.Stream photo)
        {
            SetPhotoWithHttpInfo(userId, photo);
        }
        ...
        /// <param name="itemRange">item-range pagination</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> SetPhotoWithHttpInfo (long? userId, System.IO.Stream photo, ItemRange itemRange=null)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling UserApi->SetPhoto");
            // verify the required parameter 'photo' is set
            if (photo == null)
                throw new ApiException(400, "Missing required parameter 'photo' when calling UserApi->SetPhoto");

            var localVarPath = "/users/{userId}/photo";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (photo != null) localVarFileParams.Add("photo", Configuration.ApiClient.ParameterToFile("photo", photo));
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("SetPhoto", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="photo">The file to upload.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task SetPhotoAsync (long? userId, System.IO.Stream photo)
        {
             await SetPhotoAsyncWithHttpInfo(userId, photo);
        ...
        /// <param name="photo">The file to upload.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> SetPhotoAsyncWithHttpInfo (long? userId, System.IO.Stream photo)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling UserApi->SetPhoto");
